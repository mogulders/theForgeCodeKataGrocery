...
class groceryPOSTest(unittest.TestCase):
    ...
    def testCheckBogo(self):
        ...
        self.grocery.addItemToCart('apple')
        self.assertEqual(self.grocery.total, 16.80)
    ...
    def testCheckNforX(self):
        ...
        self.grocery.addItemToCart('grape')
        self.assertEqual(self.grocery.total, 34.10)

        # this particular test is 2.3 grapes
        self.grocery.addItemToCart('grape')
        self.assertEqual(self.grocery.total, 40)

        # this particular test is 3.8 grapes
        self.grocery.addItemToCart('grape')
        self.assertEqual(self.grocery.total, 50.400000000000006)
    ...
    def testNMatX(self):
        ...
        self.grocery.addItemToCart('banana')
        self.assertEqual(self.grocery.total, 24.6000000000000005)

        # this particular test is 3.7 Banana # didn't use specialty
        self.grocery.addItemToCart('banana')
        self.assertEqual(self.grocery.total, 34.200000000000003)

        # this particular test is 2.1 Banana
        self.grocery.addItemToCart('banana')
        self.assertEqual(self.grocery.total, 39.00)
        ...
        self.grocery.addItemToCart('banana')
        self.assertEqual(self.grocery.total, 49.50)

        ## this particular test is 4.8 Banana
        self.grocery.addItemToCart('banana')
        self.assertEqual(self.grocery.total, 63.900000000000006)
